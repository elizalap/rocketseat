...
export function CreateTripPage() {
  ...
  function addNewEmilToInvite(event: FormEvent<HTMLFormElement>) {
          ...
          <div className="w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
            <div className="space-y-2">
              ...
              <p className="text-sm text-zinc-400">
                Os convidados irão receber e-mails para confirmar  participação na viagem.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-2">
              {emailsToInvite.map(email => {
                return (
                  <div key={email} className="rounded-md bg-zinc-800 flex items-center gap-2 py-1.5 px-2.5 gap-2">
            ...
            <form onSubmit={addNewEmilToInvite} className="p-2 5 bg-zinc-950 border-zinc-800 rounded-lg flex items-center gap-2">
      ...
      {isConfirmTripModalOpen && (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center">
          <div className="w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
            ...
            <form onSubmit={addNewEmilToInvite} className="space-y-3">
              <div className="h-14 px-4 5 bg-zinc-950 border-zinc-800 rounded-lg flex items-center gap-2">
